...
pub fn parse_lock_file(path: &Path, content: &str) -> Result<Vec<spd_db::Package>, ParserError> {
    let name = path
        .file_name()
        .and_then(|n| n.to_str())
        .unwrap_or("");
...
pub fn parse_pylock_toml(content: &str) -> Result<Vec<spd_db::Package>, ParserError> {
...
pub fn parse_poetry_lock(content: &str) -> Result<Vec<spd_db::Package>, ParserError> {
    let value: toml::Value = toml::from_str(content)
...
pub fn parse_pipfile_lock(content: &str) -> Result<Vec<spd_db::Package>, ParserError> {
...
pub fn parse_uv_lock(content: &str) -> Result<Vec<spd_db::Package>, ParserError> {
    let value: toml::Value = toml::from_str(content)
