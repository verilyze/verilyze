...
complete -c vlz -n "__fish_vlz_needs_command" -f -a "lsp" -d 'Run the Language Server Protocol server over standard I/O (FR-042)'
...
complete -c vlz -n "__fish_vlz_using_subcommand scan" -l providers -d 'Comma-separated CVE providers, or `all` (FR-019-EXT)' -r
...
complete -c vlz -n "__fish_vlz_using_subcommand preload" -l providers -d 'Comma-separated CVE providers, or `all` (FR-019-EXT)' -r
...
complete -c vlz -n "__fish_vlz_using_subcommand preload" -l provider-http-connect-timeout-secs -d 'Vulnerability provider HTTPS connect timeout in seconds (default 15)' -r
complete -c vlz -n "__fish_vlz_using_subcommand preload" -l provider-http-request-timeout-secs -d 'Vulnerability provider HTTPS total request timeout in seconds (default 120)' -r
...
complete -c vlz -n "__fish_vlz_using_subcommand preload" -l allow-dependency-code-execution -d 'Allow package managers to execute dependency build/lifecycle code (SEC-023)'
