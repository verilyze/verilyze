...
| **FR‑010** | Exit‑code matrix | 0 normal, 1 panic, 2 mis‑config, 3 missing pkg‑mgr, 86 CVE found, configurable overrides (except 1 & 2). | `vlz scan --exit-code 99` forces exit 99 on CVE condition. |
